...
public class UsuarioDaoImpl implements UsuarioDao{
    ...
    public UsuarioF agregarUsuarioF(UsuarioF a, Connection b) {
        try {
            ...
            sql.append("insert into clientef(nombres,apellidos,fecha_nacimiento,genero,profesion) values (")
                    .append("?,?,?,?,?)");
    ...
    public List<UsuarioF> obtenerUsuariosF(Connection b) {
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("select nombres,apellidos,fecha_nacimiento,genero,profesion from clientef");
            ...
            while (rs.next()){
                ...
                u.setNacimiento(rs.getString("fecha_nacimiento"));
